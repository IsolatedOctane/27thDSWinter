...
class A2CAgent:
    ...
    def get_action(self, state):
        ...
        action = np.random.choice(self.action_size, p=probs.data)  # TODO
    ...
    def update(self, state, action_prob, reward, next_state, done):
        ...
        actor_loss = -F.log(action_prob) * advantage #TODO    
        actor_loss.backward()
...
답변: Advantage 로 어떤 행동이 상대적으로 얼마나 좋은지를 나타내며, 일반적인 Policy Gradient 방식보다 분산이 줄어듦.

질문 2: Actor와 Critic이 각각 무엇을 학습하는지 설명하시오.
답변: Actor: Policy, Critic: Value Function
'''
